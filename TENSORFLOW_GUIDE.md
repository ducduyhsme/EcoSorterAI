...
The current model uses a multi-class classification system with two categories: Organic and Inorganic. If you need to extend this system to more categories in the future:
